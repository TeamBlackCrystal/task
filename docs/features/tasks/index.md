...
| 9b | **Git ホスティング↔タスク連携**（PR・コミット・ブランチのリンク・自動クローズ・コミットのアクティビティ表示。GitLab / Forgejo を見据えたホスト中立モデル） | [tasks/github-tasks](/features/tasks/github-tasks) | 1, 8, 9a, レビュー指摘 | 未着手（仕様改訂 2026-09-02） |
